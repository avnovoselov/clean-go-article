...
Перевод этой [статьи](https://github.com/Pungyeon/clean-go-article) является справочником для сообщества Go, призванным, помочь разработчикам писать более чистый код.
...
Применение лучших парадигм и стандартов написания кода экономит время в попытке понять свой собственный (или чей-то еще) код.
